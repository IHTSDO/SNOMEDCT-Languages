...
"use strict";
  ...
  this.rules[11].opcodes[0] = {type: 7, string: [94]};// TLS
  ...
  this.rules[15].opcodes[0] = {type: 7, string: [42]};// TLS
  ...
  this.rules[17].opcodes[0] = {type: 7, string: [60]};// TLS

  /* descendantOrSelfOf */
  this.rules[18].opcodes = [];
  this.rules[18].opcodes[0] = {type: 7, string: [60,60]};// TLS

  /* childOf */
  this.rules[19].opcodes = [];
  this.rules[19].opcodes[0] = {type: 7, string: [60,33]};// TLS

  /* ancestorOf */
  this.rules[20].opcodes = [];
  this.rules[20].opcodes[0] = {type: 7, string: [62]};// TLS

  /* ancestorOrSelfOf */
  this.rules[21].opcodes = [];
  this.rules[21].opcodes[0] = {type: 7, string: [62,62]};// TLS

  /* parentOf */
  this.rules[22].opcodes = [];
  this.rules[22].opcodes[0] = {type: 7, string: [62,33]};// TLS
  ...
  this.rules[38].opcodes[0] = {type: 7, string: [46,46]};// TLS
  ...
  this.rules[40].opcodes[0] = {type: 7, string: [42]};// TLS

  /* reverseFlag */
  this.rules[41].opcodes = [];
  this.rules[41].opcodes[0] = {type: 7, string: [114]};// TLS
  ...
  this.rules[44].opcodes[0] = {type: 1, children: [1,2,3,4,5,6]};// ALT
  this.rules[44].opcodes[1] = {type: 7, string: [61]};// TLS
  this.rules[44].opcodes[2] = {type: 7, string: [33,61]};// TLS
  this.rules[44].opcodes[3] = {type: 7, string: [60,61]};// TLS
  this.rules[44].opcodes[4] = {type: 7, string: [60]};// TLS
  this.rules[44].opcodes[5] = {type: 7, string: [62,61]};// TLS
  this.rules[44].opcodes[6] = {type: 7, string: [62]};// TLS
